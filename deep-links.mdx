...
with a specific set of products and optional per-item metadata the moment the
shopper lands on the page. It's how merchants launch customers into Hemsy from
product pages, emails, ads, blog posts, collection tiles, or bundle landing
pages without making them rebuild their look from scratch.
