---
title: "Hemsy Embeds"
description: "Launch Hemsy on your storefront: blank, pre-loaded with products, with a shared look, inside a guided flow, or with instant generation."
---
...
<Note>
  **Instant mode and share are not compatible on the same script tag.** When
  ...
  need both instant and share launchers on the same page.
</Note>
...
<Warning>
  Do not use share launchers on a page where the embed script has
  `data-hemsy-mode="instant"`. Share requires default script mode. See [Launch
  Resolution](#launch-resolution) for details.
</Warning>
