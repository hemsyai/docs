...
You can also set `anonymousId` on `window.HemsyEmbedConfig` (see [Hemsy Embeds](/embeds)).
...
- [Hemsy Embeds](/embeds) — embedded launch modes, `data-hemsy-anonymous-id`, cart vs checkout
